...
namespace InsuranceCompany.Library.Migrations
{
    ...
    [Migration("20230321222323_UpdatedBranchEntity")]
    partial class UpdatedBranchEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InsuranceCompany.Library.Core.Model.TowingService", b =>
                {
                    ...
                    b.HasIndex("BranchId", "BranchAgencyId");
            ...
            modelBuilder.Entity("InsuranceCompany.Library.Core.Model.Worker", b =>
                {
                    ...
                    b.Property<int>("WorksInBranchAgencyId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("WorksInBranchId", "WorksInBranchAgencyId");
            ...
            modelBuilder.Entity("InsuranceCompany.Library.Core.Model.TowingService", b =>
                {
                    b.HasOne("InsuranceCompany.Library.Core.Model.Branch", "Branch")
                        .WithMany()
                        .HasForeignKey("BranchId", "BranchAgencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InsuranceCompany.Library.Core.Model.Worker", b =>
                {
                    ...
                    b.HasOne("InsuranceCompany.Library.Core.Model.Branch", "WorksInBranch")
                        .WithMany()
                        .HasForeignKey("WorksInBranchId", "WorksInBranchAgencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
